...
// The dashboard link is per-user now — generated by the bot at send-time and
// attached as an inline button. No longer baked into the welcome template.
...
/reset — reset your dashboard password
/report — quick summary of this month
/undo — delete the last entry
/lang — change language
/help — show this anytime

🌐 *Your dashboard* — tap the button below to open your personal dashboard. Charts, trends, runway, and your full transaction history.
...
🛠 *Buyruqlar*
/dashboard — boshqaruv panelini ochish
...
🌐 *Sizning panelingiz* — quyidagi tugmani bosing va shaxsiy boshqaruv panelingizni oching. Grafiklar, tendensiyalar, pul yetishi va to'liq tranzaksiyalar tarixi.
...
🌐 *Ваша панель* — нажмите кнопку ниже, чтобы открыть личную панель. Графики, тренды, запас денег и полная история транзакций.
